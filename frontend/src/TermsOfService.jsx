  ...
  return (
    <div className="legal-page">
      <div className="legal-container">
        ...
        <p>
          Welcome to RavenLoom. These Terms of Service ("Terms") govern your access to and use of
          the RavenLoom team collaboration and AI assistant service (the "Service") operated by
          RavenLoom ("we," "our," or "us").
        </p>

        <p>
          By accessing or using the Service, you agree to be bound by these Terms. If you do not
          agree to these Terms, do not access or use the Service.
        </p>

        <h2>1. Acceptance of Terms</h2>
        <p>
          By creating an account or using the Service, you represent that you are at least 18 years
          old (or the age of majority in your jurisdiction) and have the legal capacity to enter into
        ...
        <p>
          RavenLoom is a team collaboration platform that includes AI-powered features to help teams
          communicate, organize information, and work more effectively. The Service includes:
        </p>
        <ul>
          <li>Team messaging and communication channels</li>
          <li>AI assistant ("Raven") for team support</li>
          <li>Knowledge management and fact storage</li>
          <li>Task tracking and alerts</li>
        ...
        <ul>
          ...
          <li>Engage in unauthorized access to the Service or related systems</li>
        ...
        <p>
          You retain ownership of content you submit to the Service ("User Content"). By submitting
          User Content, you grant us a worldwide, non-exclusive, royalty-free license to use, store,
          display, reproduce, and distribute your User Content solely for the purpose of operating
          and providing the Service.
        </p>

        <h3>5.2 Content Responsibilities</h3>
        <p>
          You are solely responsible for your User Content. You represent that you have all rights
          necessary to submit your User Content and that it does not violate any third-party rights
          or these Terms.
        </p>
        ...
        <h2>6. AI Features and Limitations</h2>
        <p>
          The Service includes AI-powered features. You acknowledge and agree that:
        </p>
        <ul>
          <li>AI responses are generated automatically and may contain errors or inaccuracies</li>
          <li>AI features are provided "as is" without warranties of accuracy or completeness</li>
          <li>You should not rely solely on AI responses for critical decisions</li>
          <li>AI features may be modified, suspended, or discontinued at any time</li>
          <li>Your content may be processed by third-party AI providers</li>
        </ul>

        <h2>7. Third-Party Services</h2>
        <p>
          The Service may integrate with third-party services (such as Google Drive). Your use of
        ...
        <p>
          The Service and its original content, features, and functionality are owned by RavenLoom
          and are protected by copyright, trademark, and other intellectual property laws. You may
          not copy, modify, distribute, sell, or lease any part of the Service without our prior
          written consent.
        </p>
        ...
        <p>
          TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL RAVENLOOM, ITS
        ...
        <p>
          IN NO EVENT SHALL OUR TOTAL LIABILITY EXCEED THE GREATER OF ONE HUNDRED DOLLARS ($100.00)
          OR THE AMOUNT YOU PAID US, IF ANY, IN THE PAST SIX MONTHS FOR THE SERVICE.
        </p>

        <h2>12. Indemnification</h2>
        <p>
          You agree to indemnify, defend, and hold harmless RavenLoom and its affiliates, directors,
          ...
          with your access to or use of the Service, your User Content, or your violation of these
          Terms.
        </p>
        ...
        <p>
          You may terminate your account at any time by discontinuing use of the Service and
        ...
        <p>
          ...
          of Indiana, United States, without regard to its conflict of law provisions.
        </p>
        <p>
          Any dispute arising from these Terms or the Service shall be resolved exclusively in the
          state or federal courts located in Indiana. You consent to the personal jurisdiction of
          such courts and waive any objection to venue in such courts.
        </p>

        <h2>15. Arbitration Agreement</h2>
        <p>
          For any dispute not resolved informally, you and RavenLoom agree to resolve the dispute
          ...
          Indiana. The arbitrator's decision shall be final and binding.
        </p>
        <p>
          YOU UNDERSTAND THAT BY AGREEING TO ARBITRATION, YOU ARE WAIVING YOUR RIGHT TO A JURY
        ...
        <p>
          ...
          changes by posting the updated Terms on the Service and updating the "Effective Date."
          Your continued use of the Service after any changes constitutes acceptance of the new Terms.
        </p>

        <h2>18. Modifications to Service</h2>
        <p>
        ...
        <h2>20. Waiver</h2>
        <p>
          The failure of RavenLoom to enforce any right or provision of these Terms shall not
        ...
        <p>
          ...
          you and RavenLoom regarding the Service and supersede all prior agreements and
          understandings.
        </p>
